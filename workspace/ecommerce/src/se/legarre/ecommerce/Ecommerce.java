...
public final class Ecommerce
{
	...
	private boolean placeOrder(ClientModel client)
	{
		...
		if (orderPlaced)
		{
			System.out.println("\nResult of placeOrder: Order realized\n\nOrder-validation with succed result was Satisfactory");
		}
		else
		{
			System.out
			...
			System.out.println("\nOrder-validation with failed result was Satisfactory\n");
		}
	...
	public static void main(String[] args) throws CloneNotSupportedException
	{
		...
		System.out.println("\n------------------\nSTORE BBDD visualization efter orders\n------------------");
		ecommerce.printStore();
		System.out.println("\nProducts substracted from BBDD. Test satisfactory.\n");
		System.out.println("******************\nEnd dynamic Test\n*******************\n");
